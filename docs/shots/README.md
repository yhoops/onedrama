...
| 这里的文件 | 来源 | 说明 |
| --- | --- | --- |
| `library-light.jpg` | `build/shots/new-29-home-light.png` | 短剧库，浅色 |
| `detail-dark.jpg` | `build/shots/new-24-detail-dark.png` | 详情页，深色 |
| `player.jpg` | `build/shots/07-player.png` | 播放页（右侧竖控制栏） |
